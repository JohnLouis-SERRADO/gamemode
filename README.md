...
**Chaque palier a son passif, et il fonctionne** — les 27 spécialités, les 81 Voies *et* les 162 Éveils. Le Faucheur reprend 25 % en PV sur *tous* ses sorts et exécute les cibles sous 15 % de vie, le Chevalier Noir paie ses sorts en sang quand le mana manque, l'Assassin ouvre sur un critique garanti, le Chaman retient l'esprit d'un allié tombé. Au niveau 50, la Voie prend le relais : le Colosse du Géant porte vraiment +60 % de PV, le Rôdeur de la Meute entre en combat avec trois compagnons, la Danselame du Miroir riposte à chaque coup encaissé, l'Oracle de la Vision fait esquiver toute l'équipe, le Corrupteur de la Peste contamine l'arène entière.

Au niveau 80, l'Éveil pose la dernière couche — **et sa contrainte avec**. « Fléau Premier » rend vraiment tous les coups critiques, et lui coûte vraiment une manche d'action sur deux ; « Muraille Vivante » empêche vraiment l'équipe de tomber, et lui coupe vraiment les soins de ses alliés. C'est la contrainte qui tient la règle d'équilibrage : *la rareté augmente la complexité, jamais le plafond de puissance*. Un Divin sans contrainte branchée aurait été un Divin gratuitement meilleur.

Le texte d'un passif n'est plus écrit à la main : il est **produit à partir des chiffres qui le font tourner** (`js/data/passifs.js`, `js/data/voies-passifs.js`, `js/data/eveils-passifs.js`). Une fiche ne peut donc plus promettre autre chose que ce que le moteur applique — et un réglage sans phrase, comme une phrase sans réglage, fait échouer les tests. Les trois étages se **recouvrent** sans jamais s'effacer : spécialité, puis Voie, puis Éveil. Le Faucheur de la Voie du Drain passe de 25 à 40 % de vol de vie, garde son exécution de spécialité, et son Éveil « Passeur » la relève encore à 20 % des PV de la cible.

**377 compétences** au total : 56 de classe (48 pour les six classes jouables, plus les 8 de l'Aventurier historique, gardées pour les vieilles sauvegardes), 216 de spécialité, 81 de Voie et 24 du pool commun acheté à l'Arcanium. Ce pool commun est le seul qui s'achète : les compétences de spécialité et de Voie se méritent à leur palier, jamais en boutique. **L'Éveil, lui, n'apporte aucune compétence depuis la v29 : c'est un passif de joueur pur** — son effet (et sa contrainte) coulent en permanence, la Voie reste le seul palier à donner à la fois un passif *et* une capacité. Toujours **8 sorts équipés au maximum** — l'arbitrage ne disparaît jamais.
...
- **39 donjons d'histoire** écrits comme des aventures de *Donjons & Dragons* : dialogues, choix à conséquences, **votes d'équipe**, **épreuves au d20**, boss à phases et épilogues à variantes.
  ...
  - 🔥 **Trois difficultés par histoire** (v29) — Normal, Héroïque, Cauchemar, ouvertes dans l'ordre : terminer une histoire à un palier ouvre le suivant. **La règle du double** : chaque palier double les monstres (PV *et* attaque) et double les récompenses de fin — Héroïque ×2, Cauchemar ×4. La première complétion de chaque palier paie plein tarif ; revivre un palier déjà vécu rapporte 35 %. La **relique unique** de l'histoire, elle, ne tombe qu'une fois. Un chapitre commencé se reprend à *sa* difficulté, et l'insigne de la carte dit le plus haut palier vaincu (✅ / ✅🔥 / ✅💀).
...
- **Tours sans fin** : la Tour Sans Fin et la Tour des Boss (16 boss, Normal/Héroïque/Cauchemar — la règle du double s'y applique aussi : monstres ×2 en Héroïque, ×4 en Cauchemar, coffre d'étage plus garni d'un tirage par palier). **Un point de sauvegarde tous les 10 étages** : l'équipe y campe (PV et PM rendus) et le palier est gravé — l'ascension suivante peut repartir de là, ou du bas pour ceux qui veulent la course entière. Entre deux paliers, rien ne change : aucun soin, aucune pitié. La même règle vaut pour l'Ascension éternelle des épopées, avec un palier par épopée et par difficulté.
- **Taverne** : chat, sept classements, boss du monde à barre de vie partagée, comptoir d'échange.
- **39 hauts faits**, 6 races à passifs, 13 familiers à bonus.
...
js/data/eveils-passifs.js        — les 162 passifs d'Éveil et leurs 20 contraintes : réglages et texte produit
