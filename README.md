...
- **Les expéditions de groupe** (jusqu'à 4 appareils) proposent six genres : explorer une zone, son boss, un étage de la **Tour Sans Fin**, la **Tour des Boss**, l'**assaut du boss final d'un donjon** que TOUTE l'équipe a débloqué, ou l'**Ascension éternelle d'une épopée** terminée par tous — des étages **sans fin, enchaînés sans soin ni retour au salon** (écho du boss tous les 5 étages, épreuve au d20 tous les 3 — le plus doué de l'équipe s'y colle, le sort de tous en dépend), le record de chacun progressant à chaque étage conquis. Tout est calé sur le **moins avancé** du groupe (étages, difficultés, déblocages), les plus aguerris sont **bridés au niveau du plus bas**, les **invocations** combattent aussi en ligne, et la **défaite est mortelle** — la vraie mort, sur chaque écran, comme en solo.
