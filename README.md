...
- **Les expéditions de groupe** (jusqu'à 4 appareils) proposent cinq genres : explorer une zone, son boss, un étage de la **Tour Sans Fin**, la **Tour des Boss**, ou l'**assaut du boss final d'un donjon** que TOUTE l'équipe a débloqué — toujours calés sur le **moins avancé** du groupe (étages, difficultés… et le record de chacun progresse à la victoire). En groupe, les plus aguerris sont **bridés au niveau du plus bas** pour que l'aventure reste cohérente, les **invocations** combattent aussi en ligne, et la **défaite est mortelle** — la vraie mort, sur chaque écran, comme en solo.
