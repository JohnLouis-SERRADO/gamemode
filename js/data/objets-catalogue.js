...
const OBJETS = {
  ...
  'lame-crepuscule':  { nom: 'Lame du crépuscule', emoji: '🌘', type: 'equipement', slot: 'arme', familleArme: 'lame', niveau: 68, prixVente: 1142, bonus: { for: 46, dex: 10, crit: 16 }, desc: 'Une lame légendaire, forgée à l’atelier seulement.' },
  ...
  'sceptre-neant':    { nom: 'Sceptre du néant', emoji: '🌀', type: 'equipement', slot: 'arme', familleArme: 'baton', niveau: 68, prixVente: 1142, bonus: { int: 46, pmMax: 65, crit: 16 }, desc: 'Un artefact légendaire, forgé à l’atelier seulement.' },
  ...
  'arc-du-vent':      { nom: 'Arc du vent', emoji: '🌪️', type: 'equipement', slot: 'arme', familleArme: 'arc', niveau: 68, prixVente: 1142, bonus: { dex: 46, crit: 26 }, desc: 'Un arc légendaire, forgé à l’atelier seulement.' },
  ...
  'couronne-mystique': { nom: 'Couronne mystique', emoji: '👑', type: 'equipement', slot: 'tete', niveau: 64, prixVente: 846, bonus: { int: 14, vit: 10, pmMax: 51 }, desc: 'Se fabrique à l’atelier seulement.' },
  ...
  'armure-draconique': { nom: 'Armure draconique', emoji: '🐲', type: 'equipement', slot: 'torse', niveau: 68, prixVente: 1073, bonus: { vit: 21, for: 7, pvMax: 143 }, desc: 'Se forge à l’atelier avec des écailles de dragon.' },
  ...
  'jambieres-zephyr': { nom: 'Jambières du zéphyr', emoji: '💨', type: 'equipement', slot: 'jambes', niveau: 16, prixVente: 274, bonus: { dex: 4, vit: 3, crit: 3 }, desc: 'Se cousent à l’atelier seulement.' },
  ...
  'oeil-dragon':      { nom: 'Œil de dragon', emoji: '🐉', type: 'equipement', slot: 'accessoire', niveau: 68, prixVente: 1365, bonus: { for: 10, int: 10, crit: 17 }, desc: 'Se sertit à l’atelier seulement.' },
  'coeur-givre':      { nom: 'Cœur de givre', emoji: '❄️', type: 'equipement', slot: 'accessoire', niveau: 68, prixVente: 1024, bonus: { vit: 10, pvMax: 102 }, desc: 'Se taille à l’atelier seulement.' },
  ...
  'orbe-des-dunes':    { nom: 'Orbe des dunes', emoji: '🔮', type: 'equipement', slot: 'accessoire', niveau: 28, prixVente: 228, bonus: { int: 5, dex: 4, crit: 4 }, desc: 'Se façonne à l’atelier avec des perles des sables.' },
  ...
  'soie-araignee':     { nom: 'Soie d’araignée', emoji: '🕸️', type: 'materiau', prixVente: 13, desc: 'Plus solide que l’acier, à poids égal.' },
  ...
  'minerai-cuivre':    { nom: 'Minerai de cuivre', emoji: '🟠', type: 'materiau', prixVente: 8, desc: 'Extrait des Collines de Cuivre.' },
  'minerai-fer':       { nom: 'Minerai de fer', emoji: '⛏️', type: 'materiau', prixVente: 55, desc: 'Le métal des armes sérieuses.' },
  'os-ancien':         { nom: 'Os ancien', emoji: '🦴', type: 'materiau', prixVente: 190, desc: 'Imprégné de vieille magie.' },
  'poussiere-spectre': { nom: 'Poussière de spectre', emoji: '👻', type: 'materiau', prixVente: 220, desc: 'Froide au toucher, quel que soit le temps.' },
  'cristal-givre':     { nom: 'Cristal de givre', emoji: '❄️', type: 'materiau', prixVente: 420, desc: 'Ne fond jamais.' },
  'noyau-golem':       { nom: 'Noyau de golem', emoji: '🗿', type: 'materiau', prixVente: 480, desc: 'Le cœur encore tiède d’un golem.' },
  'ecaille-draconique': { nom: 'Écaille draconique', emoji: '🐲', type: 'materiau', prixVente: 520, desc: 'Le matériau le plus précieux du royaume.' },
  'lotus-noir':         { nom: 'Lotus noir', emoji: '🪷', type: 'materiau', prixVente: 16, desc: 'Ne fleurit que dans la brume des marais.' },
  'perle-des-sables':   { nom: 'Perle des sables', emoji: '💠', type: 'materiau', prixVente: 110, desc: 'Le désert la polit pendant un siècle.' },
  ...
  'couronne-de-soie':     { nom: 'Couronne de soie', emoji: '🕷️', type: 'equipement', slot: 'tete',       niveau: 8,  rarete: 'epique',     prixVente: 171, bonus: { dex: 3, int: 2, pmMax: 9 }, desc: 'Trophée de la Matriarche des Murmures.' },
  'pagne-du-chef-orc':    { nom: 'Pagne du chef orc', emoji: '👹', type: 'equipement', slot: 'jambes',     niveau: 24,  rarete: 'epique',     prixVente: 368, bonus: { for: 6, vit: 6, pvMax: 29 }, desc: 'Trophée du Chef de guerre des Collines.' },
  'coeur-de-l-hydre':     { nom: 'Cœur de l’Hydre', emoji: '🐉', type: 'equipement', slot: 'accessoire', niveau: 12, rarete: 'epique',     prixVente: 253, bonus: { int: 4, vit: 2, pmMax: 13 }, desc: 'Trophée de l’Hydre des brumes. Il bat encore.' },
  'sceau-du-roi-dechu':   { nom: 'Sceau du Roi déchu', emoji: '💍', type: 'equipement', slot: 'accessoire', niveau: 44, rarete: 'legendaire', prixVente: 817, bonus: { int: 13, cha: 5, crit: 8 }, desc: 'Trophée du maître des Cryptes Oubliées.' },
  'dent-du-ver':          { nom: 'Dent du Ver colossal', emoji: '🪱', type: 'equipement', slot: 'arme', familleArme: 'lame',       niveau: 32, rarete: 'legendaire', prixVente: 679, bonus: { for: 20, cha: 5, crit: 7 }, desc: 'Trophée du Ver des sables. Encore acérée.' },
  'noyau-de-l-ancien':    { nom: 'Noyau de l’Ancien', emoji: '🌋', type: 'equipement', slot: 'accessoire', niveau: 68, rarete: 'legendaire', prixVente: 1408, bonus: { vit: 16, pvMax: 94, cha: 6 }, desc: 'Trophée de l’Élémentaire ancien des Pics.' },
  'larme-du-gardien':     { nom: 'Larme du Gardien', emoji: '💧', type: 'equipement', slot: 'accessoire', niveau: 71, rarete: 'legendaire', prixVente: 1802, bonus: { for: 12, int: 12, dex: 12, cha: 9 }, desc: 'Trophée du Gardien éternel des Profondeurs.' },
};

// ----- Matériaux des Terres lointaines (v10, niv. 22-50) -----
Object.assign(OBJETS, {
  'liane-tressee':      { nom: 'Liane tressée', emoji: '🌿', type: 'materiau', prixVente: 22, desc: 'Souple comme une corde, solide comme une chaîne.' },
  'orchidee-lunaire':   { nom: 'Orchidée lunaire', emoji: '🌸', type: 'materiau', prixVente: 28, desc: 'Ne fleurit que sous la pleine lune de la jungle.' },
  'venin-concentre':    { nom: 'Venin concentré', emoji: '🧪', type: 'materiau', prixVente: 34, desc: 'À manipuler avec des gants. Deux paires.' },
  'basalte-poli':       { nom: 'Basalte poli', emoji: '🪨', type: 'materiau', prixVente: 70, desc: 'Poli par mille ans de vents hurlants.' },
  'plume-de-rokh':      { nom: 'Plume de rokh', emoji: '🪶', type: 'materiau', prixVente: 85, desc: 'Plus grande qu’un bouclier, plus légère qu’un souffle.' },
  'cristal-hurleur':    { nom: 'Cristal hurleur', emoji: '💎', type: 'materiau', prixVente: 100, desc: 'Il siffle quand le vent tourne. Et le vent tourne toujours.' },
  'nacre-abyssale':     { nom: 'Nacre abyssale', emoji: '🐚', type: 'materiau', prixVente: 360, desc: 'Elle garde la lumière des lanternes englouties.' },
  'corail-sanglant':    { nom: 'Corail sanglant', emoji: '🪸', type: 'materiau', prixVente: 390, desc: 'Rouge profond. Personne ne demande pourquoi.' },
  'larme-de-sirene':    { nom: 'Larme de sirène', emoji: '💧', type: 'materiau', prixVente: 450, desc: 'Un chagrin cristallisé, précieux et froid.' },
  'cendre-fertile':     { nom: 'Cendre fertile', emoji: '🌫️', type: 'materiau', prixVente: 120, desc: 'Tout y repousse — même ce qu’on préférerait éteint.' },
  'obsidienne-brute':   { nom: 'Obsidienne brute', emoji: '🖤', type: 'materiau', prixVente: 135, desc: 'Un tranchant naturel qui n’attend que la meule.' },
  'coeur-de-braise':    { nom: 'Cœur de braise', emoji: '❤️‍🔥', type: 'materiau', prixVente: 160, desc: 'Chaud au toucher, des années après.' },
  'bois-petrifie':      { nom: 'Bois pétrifié', emoji: '🪵', type: 'materiau', prixVente: 40, desc: 'Un arbre devenu pierre — le grain du bois y est encore.' },
  'ambre-noir':         { nom: 'Ambre noir', emoji: '🟤', type: 'materiau', prixVente: 48, desc: 'Quelque chose est figé dedans. Ne regardez pas trop longtemps.' },
  'sphere-runique':     { nom: 'Sphère runique', emoji: '🔮', type: 'materiau', prixVente: 60, desc: 'Les runes tournent lentement à l’intérieur.' },
  'os-de-geant':        { nom: 'Os de géant', emoji: '🦴', type: 'materiau', prixVente: 150, desc: 'Un seul fémur ferait une charpente.' },
  'peau-de-mammouth':   { nom: 'Peau de mammouth', emoji: '🦣', type: 'materiau', prixVente: 170, desc: 'Assez pour tailler trois manteaux et une tente.' },
  'relique-antique':    { nom: 'Relique antique', emoji: '⚱️', type: 'materiau', prixVente: 200, desc: 'D’avant les Royaumes. D’avant beaucoup de choses.' },
  'fragment-de-foudre': { nom: 'Fragment de foudre', emoji: '⚡', type: 'materiau', prixVente: 540, desc: 'Un éclair figé en plein zigzag.' },
  'acier-celeste':      { nom: 'Acier céleste', emoji: '⚙️', type: 'materiau', prixVente: 580, desc: 'Forgé dans les nuages, trempé dans l’orage.' },
  'plume-d-archon':     { nom: 'Plume d’Archon', emoji: '🕊️', type: 'materiau', prixVente: 660, desc: 'Elle flotte à deux doigts de votre paume, toujours.' },
  'etoffe-du-neant':    { nom: 'Étoffe du néant', emoji: '🌌', type: 'materiau', prixVente: 820, desc: 'Un tissu découpé dans l’absence de tout.' },
  'eclat-d-etoile':     { nom: 'Éclat d’étoile', emoji: '⭐', type: 'materiau', prixVente: 880, desc: 'Encore tiède. Encore un peu vivant.' },
  'essence-primordiale': { nom: 'Essence primordiale', emoji: '✨', type: 'materiau', prixVente: 1000, desc: 'La matière première du monde, en flacon.' },

  // ----- Trophées uniques des boss des Terres lointaines -----
  'crochet-de-sarpense':  { nom: 'Crochet de Sarpense', emoji: '🐍', type: 'equipement', slot: 'arme', familleArme: 'arc', niveau: 16, rarete: 'epique', prixVente: 460, bonus: { dex: 12, for: 4, crit: 3 }, desc: 'Trophée de la Matriarche de Vaï-Sombre.' },
  ...
  'fanon-du-leviathan':   { nom: 'Fanon du Léviathan', emoji: '🐋', type: 'equipement', slot: 'accessoire', niveau: 64, rarete: 'legendaire', prixVente: 1817, bonus: { int: 17, vit: 13, pmMax: 50 }, desc: 'Trophée du maître des Abysses d’Émeraude.' },
  'coeur-du-behemoth':    { nom: 'Cœur du Béhémoth', emoji: '🌋', type: 'equipement', slot: 'accessoire', niveau: 36, rarete: 'legendaire', prixVente: 1100, bonus: { for: 10, vit: 8, pvMax: 45, deter: 4 }, desc: 'Trophée du Béhémoth de la Steppe. Il bat encore, lentement.' },
  'oeil-de-quartz':       { nom: 'Œil de Quartz', emoji: '💎', type: 'equipement', slot: 'tete', niveau: 20, rarete: 'legendaire', prixVente: 847, bonus: { int: 7, vit: 4, crit: 3, pmMax: 16 }, desc: 'Trophée de l’Avatar de la Forêt Pétrifiée.' },
  'couronne-d-ossements': { nom: 'Couronne d’Ossements', emoji: '👑', type: 'equipement', slot: 'tete', niveau: 40, rarete: 'legendaire', prixVente: 1474, bonus: { for: 13, vit: 7, pvMax: 55, deter: 5 }, desc: 'Trophée du Roi de la Vallée des Géants.' },
  'aile-de-l-archonte':   { nom: 'Aile de l’Archonte', emoji: '🕊️', type: 'equipement', slot: 'accessoire', niveau: 74, rarete: 'mythique', prixVente: 3411, bonus: { dex: 20, int: 14, crit: 11, celerite: 9 }, desc: 'Trophée de l’Archonte de la Tempête. Elle bat encore la mesure de l’orage.' },
  'singularite-apprivoisee': { nom: 'Singularité apprivoisée', emoji: '🕳️', type: 'equipement', slot: 'accessoire', niveau: 86, rarete: 'mythique', prixVente: 3917, bonus: { for: 20, int: 20, vit: 13, pvMax: 98 }, desc: 'Trophée du Dévoreur de Mondes. Ne pas secouer.' },
});
