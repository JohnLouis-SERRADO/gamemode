...
const PV_CIBLE_MONSTRE = [
      79,    92,   111,   132,   149,   165,   194,   196,   219,   283,  // 1–10
     294,   296,   321,   393,   420,   421,   535,   537,   545,   546,  // 11–20
     548,   583,   585,   594,   596,   641,   663,   685,   688,   730,  // 21–30
     734,   757,   759,   805,   809,   834,   837,   886,   890,   908,  // 31–40
     911,   964,   968,   991,   995,  1020,  1025,  1088,  1092,  1108,  // 41–50
    1114,  1153,  1159,  1173,  1179,  1248,  1254,  1261,  1267,  1317,  // 51–60
    1323,  1335,  1342,  1397,  1403,  1410,  1416,  1473,  1480,  1486,  // 61–70
    1493,  1539,  1545,  1552,  1559,  1622,  1629,  1635,  1642,  1687,  // 71–80
    1695,  1704,  1712,  1785,  1793,  1801,  1810,  1856,  1864,  1888,  // 81–90
    1896,  1960,  1968,  1976,  1985,  2041,  2049,  2057,  2066,  2136,  // 91–100
];

const ATK_CIBLE_MONSTRE = [
      8.2,    8.6,    8.9,    8.9,    9.9,    9.9,    9.9,   10.3,   10.3,   14.7,  // 1–10
     15.4,   15.7,   15.8,   16.2,   20.2,   20.4,   22.6,   25.6,   25.8,   26.1,  // 11–20
     26.3,   26.4,   26.4,   26.4,   26.7,   26.8,   30.3,   31.0,   31.4,   31.6,  // 21–30
     32.1,   34.1,   34.9,   35.2,   38.6,   38.9,   39.3,   40.9,   42.4,   43.6,  // 31–40
     44.0,   44.4,   45.4,   45.8,   46.3,   46.7,   52.9,   53.4,   53.9,   54.4,  // 41–50
     55.4,   56.1,   56.6,   57.5,   63.0,   63.6,   64.6,   65.1,   66.2,   66.9,  // 51–60
     67.9,   68.8,   69.4,   70.3,   71.3,   72.3,   73.3,   73.6,   74.6,   78.7,  // 61–70
     79.7,   79.7,   79.7,   85.1,   86.0,   86.7,   87.7,   88.3,   89.3,   90.1,  // 71–80
     91.1,   95.7,   96.7,   98.1,   99.1,  100.1,  101.6,  102.5,  103.9,  108.1,  // 81–90
    109.2,  113.2,  114.3,  115.7,  116.8,  117.8,  119.3,  120.3,  121.8,  128.4,  // 91–100
];
...
const PV_CIBLE_BOSS = [
      473,    548,    659,    784,    890,    983,   1157,   1169,   1304,   1685,  // 1–10
     1748,   1759,   1908,   2336,   2496,   2506,   3182,   3193,   3238,   3247,  // 11–20
     3258,   3464,   3480,   3531,   3546,   3812,   3942,   4075,   4090,   4340,  // 21–30
     4361,   4497,   4511,   4783,   4806,   4957,   4977,   5267,   5292,   5395,  // 31–40
     5417,   5729,   5755,   5889,   5913,   6064,   6092,   6463,   6490,   6584,  // 41–50
     6622,   6854,   6890,   6971,   7007,   7418,   7456,   7493,   7532,   7829,  // 51–60
     7863,   7937,   7975,   8300,   8338,   8378,   8417,   8756,   8794,   8834,  // 61–70
     8873,   9145,   9184,   9223,   9262,   9639,   9679,   9718,   9757,  10026,  // 71–80
    10076,  10125,  10173,  10607,  10657,  10705,  10754,  11030,  11079,  11218,  // 81–90
    11267,  11647,  11696,  11745,  11794,  12128,  12177,  12226,  12275,  12696,  // 91–100
];

const ATK_CIBLE_BOSS = [
      9.4,    9.9,   10.2,   10.2,   11.4,   11.4,   11.4,   11.8,   11.8,   16.9,  // 1–10
     17.7,   18.0,   18.1,   18.6,   23.1,   23.4,   26.0,   29.3,   29.6,   29.9,  // 11–20
     30.2,   30.3,   30.3,   30.3,   30.6,   30.8,   34.8,   35.5,   36.0,   36.2,  // 21–30
     36.8,   39.0,   40.1,   40.3,   44.2,   44.6,   45.0,   46.9,   48.6,   50.0,  // 31–40
     50.4,   50.9,   52.1,   52.5,   53.1,   53.6,   60.6,   61.3,   61.8,   62.3,  // 41–50
     63.5,   64.3,   64.9,   66.0,   72.2,   72.9,   74.1,   74.7,   75.9,   76.7,  // 51–60
     77.8,   78.9,   79.5,   80.6,   81.7,   82.9,   84.0,   84.3,   85.5,   90.2,  // 61–70
     91.3,   91.3,   91.3,   97.5,   98.6,   99.4,  100.6,  101.2,  102.4,  103.3,  // 71–80
    104.5,  109.7,  110.9,  112.4,  113.6,  114.8,  116.5,  117.4,  119.1,  123.9,  // 81–90
    125.1,  129.8,  131.0,  132.7,  133.9,  135.0,  136.7,  137.9,  139.6,  147.2,  // 91–100
];
