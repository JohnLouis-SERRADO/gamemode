...
const INVOCATIONS = {
  'loup-spectral': {
    ...
    stats: { for: 0.7, int: 0.2, dex: 0.9, esp: 0.2, vit: 0.6, cha: 0.3 },
    ligne: 'avant',
  ...
  'golem-de-basalte': {
    ...
    stats: { for: 0.8, int: 0.1, dex: 0.2, esp: 0.1, vit: 1.0, cha: 0.1 },
    ligne: 'avant',
  ...
  'feu-follet': {
    ...
    stats: { for: 0.1, int: 0.95, dex: 0.7, esp: 0.5, vit: 0.35, cha: 0.5 },
    ligne: 'arriere',
  ...
  'ondine-des-marees': {
    ...
    stats: { for: 0.2, int: 0.85, dex: 0.5, esp: 0.9, vit: 0.6, cha: 0.6 },
    ligne: 'arriere',
  ...
  'corbeau-d-orage': {
    ...
    stats: { for: 0.3, int: 0.75, dex: 0.95, esp: 0.8, vit: 0.4, cha: 0.6 },
    ligne: 'arriere',
  ...
  'ombre-de-nihelm': {
    ...
    stats: { for: 0.4, int: 0.9, dex: 0.8, esp: 0.4, vit: 0.45, cha: 0.4 },
    ligne: 'avant',
