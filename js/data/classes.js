...
const COMPETENCES_SIGNATURE = {
  ...
  'signature-zero-absolu':        { nom: 'Cœur de l’hiver', emoji: '🧊', classe: 'givremage', signature: true, categorie: 'signature', type: 'degats', cible: 'ennemi', stat: 'int', puissance: 11, ratio: 1.5, effet: { type: 'etourdi', duree: 1, chance: 0.6 }, coutMp: 12, cooldown: 6, desc: 'Là où le froid s’arrête, l’ennemi aussi.' },
...
const COMPETENCES_CLASSE = {
  ...
  // Mage
  'mage-flux-arcanique':      { classe: 'mage', niveauRequis: 5, nom: 'Flux arcanique', emoji: '🌀', categorie: 'signature', type: 'utilitaire', cible: 'soi', effet: { type: 'mana', valeur: 12 }, coutMp: 0, cooldown: 4, desc: 'Aspire le mana ambiant : rend une part de la réserve (au moins 12 PM).' },
  ...
  'archer-double-tir':        { classe: 'archer', niveauRequis: 10, nom: 'Triple tir', emoji: '🏹', categorie: 'signature', type: 'degats', cible: 'ennemi', stat: 'dex', puissance: 5, ratio: 0.9, coups: 3, coutMp: 8, cooldown: 4, desc: 'Trois flèches encochées d’un seul geste — le Tir double, dépassé.' },
  ...
  'paladin-lame-consacree':   { classe: 'paladin', niveauRequis: 10, nom: 'Lame consacrée', emoji: '🗡️', categorie: 'signature', type: 'degats', cible: 'ennemi', stat: 'for', puissance: 10, ratio: 1.4, effet: { type: 'drain', part: 0.3 }, coutMp: 9, cooldown: 4, desc: 'Frappe sacrée qui rend 30 % des dégâts infligés en vie.' },
  ...
  // Danselame
  'danselame-pas-de-cote':    { classe: 'danselame', niveauRequis: 5, nom: 'Pas de côté', emoji: '🩰', categorie: 'signature', type: 'utilitaire', cible: 'soi', effet: { type: 'bouclier', duree: 2, stat: 'dex' }, coutMp: 5, cooldown: 4, desc: 'La Célérité, c’est danser plus vite que la lame.' },
  ...
  'mage-siphon-de-mana':      { classe: 'mage', niveauRequis: 1, nom: 'Siphon de mana', emoji: '🌀', categorie: 'signature', type: 'utilitaire', cible: 'soi', effet: { type: 'mana', valeur: 8 }, coutMp: 0, cooldown: 3, desc: 'Aspirer une part de sa réserve dans le mana ambiant, comme on reprend son souffle.' },
  // Archer
  ...
  'templier-garde-sacree':    { classe: 'templier', niveauRequis: 1, nom: 'Garde sacrée', emoji: '⛨', categorie: 'signature', type: 'utilitaire', cible: 'soi', effet: { type: 'provocation', duree: 2, stat: 'vit' }, coutMp: 4, cooldown: 4, desc: 'Tous les coups pour lui — c’est exactement le plan.' },
