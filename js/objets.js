...
const OBJETS = {
  ...
  'croc-de-guerre':   { nom: 'Croc de guerre', emoji: '🪓', type: 'equipement', slot: 'arme', niveau: 12, prix: 620, bonus: { for: 10, agi: 2 }, desc: 'Taillée pour les champs de bataille.' },
  'lame-crepuscule':  { nom: 'Lame du crépuscule', emoji: '🌘', type: 'equipement', slot: 'arme', niveau: 16, bonus: { for: 14, agi: 3, crit: 5 }, desc: 'Une lame légendaire, forgée à l’atelier seulement.' },
  ...
  'baton-tempetes':   { nom: 'Bâton des tempêtes', emoji: '⚡', type: 'equipement', slot: 'arme', niveau: 12, prix: 620, bonus: { int: 10, pmMax: 14 }, desc: 'L’orage y gronde en permanence.' },
  'sceptre-neant':    { nom: 'Sceptre du néant', emoji: '🌀', type: 'equipement', slot: 'arme', niveau: 16, bonus: { int: 14, pmMax: 20, crit: 5 }, desc: 'Un artefact légendaire, forgé à l’atelier seulement.' },
  ...
  'arc-precision':    { nom: 'Arc de précision', emoji: '🎯', type: 'equipement', slot: 'arme', niveau: 12, prix: 620, bonus: { agi: 10, crit: 4 }, desc: 'Chaque flèche trouve sa cible.' },
  'arc-du-vent':      { nom: 'Arc du vent', emoji: '🌪️', type: 'equipement', slot: 'arme', niveau: 16, bonus: { agi: 14, crit: 8 }, desc: 'Un arc légendaire, forgé à l’atelier seulement.' },
  ...
  'heaume-chevalier': { nom: 'Heaume de chevalier', emoji: '🪖', type: 'equipement', slot: 'tete', niveau: 10, prix: 340, bonus: { vit: 4, pvMax: 20 }, desc: 'Le heaume des champions.' },
  'couronne-mystique': { nom: 'Couronne mystique', emoji: '👑', type: 'equipement', slot: 'tete', niveau: 14, bonus: { int: 4, vit: 3, pmMax: 15 }, desc: 'Se fabrique à l’atelier seulement.' },
  ...
  'plastron-fer':     { nom: 'Plastron de fer', emoji: '🛡️', type: 'equipement', slot: 'torse', niveau: 10, prix: 380, bonus: { vit: 5, pvMax: 25 }, desc: 'Une forteresse portable.' },
  'armure-draconique': { nom: 'Armure draconique', emoji: '🐲', type: 'equipement', slot: 'torse', niveau: 14, bonus: { vit: 6, for: 2, pvMax: 40 }, desc: 'Se forge à l’atelier avec des écailles de dragon.' },
  ...
  'jambieres-plates': { nom: 'Jambières de plates', emoji: '🦿', type: 'equipement', slot: 'jambes', niveau: 10, prix: 300, bonus: { vit: 4, pvMax: 15 }, desc: 'Lourdes, mais sûres.' },
  'jambieres-zephyr': { nom: 'Jambières du zéphyr', emoji: '💨', type: 'equipement', slot: 'jambes', niveau: 14, bonus: { agi: 4, vit: 3, crit: 3 }, desc: 'Se cousent à l’atelier seulement.' },
  ...
  'sceau-colosse':    { nom: 'Sceau du colosse', emoji: '🔱', type: 'equipement', slot: 'accessoire', niveau: 12, prix: 520, bonus: { for: 4, pvMax: 20 }, desc: 'Pèse lourd — dans tous les sens.' },
  'oeil-dragon':      { nom: 'Œil de dragon', emoji: '🐉', type: 'equipement', slot: 'accessoire', niveau: 15, bonus: { for: 3, int: 3, crit: 5 }, desc: 'Se sertit à l’atelier seulement.' },
  'coeur-givre':      { nom: 'Cœur de givre', emoji: '❄️', type: 'equipement', slot: 'accessoire', niveau: 15, bonus: { vit: 3, pvMax: 30 }, desc: 'Se taille à l’atelier seulement.' },
...
function prixVenteDe(idObjet) {
  ...
  if (!objet) return 0;
  if (objet.type === 'materiau') return objet.prixVente;
...
// =====================================================================
const RECETTES = [
  { resultat: 'potion-soin',        niveau: 1,  po: 5,   materiaux: { 'herbe-lunaire': 2 } },
  { resultat: 'potion-mana',        niveau: 1,  po: 8,   materiaux: { 'herbe-lunaire': 1, 'seve-ambree': 1 } },
  ...
  { resultat: 'armure-draconique',  niveau: 14, po: 250, materiaux: { 'ecaille-draconique': 2, 'minerai-fer': 3, 'peau-de-loup': 2 } },
  { resultat: 'oeil-dragon',        niveau: 15, po: 350, materiaux: { 'ecaille-draconique': 1, 'cristal-givre': 1, 'noyau-golem': 1 } },
